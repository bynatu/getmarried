...
<div class="row">
    <div class="col-xs-12 col-sm-5 ta-center">
        <?php
        if (empty($image)) {
            echo $this->Html->image("empresa.png", array("alt" => "Registro Cliente", 'class' => 'logo'));
        } else {
    ...
    <div class="col-xs-12  col-sm-offset-1 col-sm-5">
        ...
        <ul id="perfil-data">
            ...
            <li><span>Sitio Web: </span>
                <span> <a href="<?php echo($datos['Empresa']['www']) ?> "
                          target="_blank"> <?php echo($datos['Empresa']['www']) ?> </a></span>
            </li>
            ...
            <li><span>Dirección: </span>
                <span><?php echo($datos['Empresa']['direccion'] . " Nº " . $datos['Empresa']['numero'] . " " . $datos['Empresa']['piso']) ?> </span>
            </li>
